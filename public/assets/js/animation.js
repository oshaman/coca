...
function f() {
    ...
    $(window).scroll(function () {
        ...
        if (now > $('.sec_4').offset().top - 500 && now < $('.sec_4').offset().top + $('.sec_4').innerHeight() - 500) {
            if (o = 1) {
                t = +1;
            } else {
                t = -1;
            }
            $('.left_sec4').animate({'top': +($('.sec_4').offset().top - now) * .3 + 'px'}, 0)
            $('.right_sec4').animate({'bottom': +( $('.sec_4').offset().top - now ) * .3 + 'px'}, 0)
        }
    })
}
...
/*****************************/
// $(window).scroll(function () {
//     var e = jQuery("html").height(), t = 0;
//     bl2 = jQuery(".prj-all").height();
//
//     $(".texts-l-r").css({height: bl2 + "px"})
//
//     Scroll = window.pageYOffset + s / 2 || document.documentElement.scrollTop + s / 2, jQuery(".wrapper  .main-title").css({top: .2 * Scroll - 100 + "px"}), 0 != jQuery("#filter").length ? (jQuery(".block1 h1").css({top: .2 * Scroll + "px"}), ScrollBefore < Scroll ? Scroll < e - s / 2 ? (jQuery(".border-line1").animate({height: Scroll}, 10, "linear"), r()) : (jQuery(".border-line1").animate({height: e - 215}, 500, "linear"), clearTimeout($.data(this, "scrollTimer")), clearInterval(a)) : Scroll < e - s / 2 - 2 ? (jQuery(".border-line1").animate({height: Scroll}, 10, "linear"), r()) : Scroll < e - s / 2 && jQuery(".border-line1").animate({height: 2505}, 500, "linear")) : 0 != jQuery(".aboutUs").length ? ScrollBefore < Scroll ? Scroll < e - s / 2 ? (jQuery(".border-line1").animate({height: Scroll}, 10, "linear"), r()) : (jQuery(".border-line1").animate({height: e - 215}, 500, "linear"), clearTimeout($.data(this, "scrollTimer")), clearInterval(a)) : Scroll < e - s / 2 - 2 ? (jQuery(".border-line1").animate({height: Scroll}, 10, "linear"), r()) : Scroll < e - s / 2 && jQuery(".border-line1").animate({height: 5224}, 500, "linear") : 0 != jQuery(".prj-all").length ? ScrollBefore < Scroll ? Scroll < e - s / 2 ? (jQuery(".border-line1").animate({height: Scroll}, 10, "linear"), r()) : (jQuery(".border-line1").animate({height: e - 215}, 500, "linear"), clearTimeout($.data(this, "scrollTimer")), clearInterval(a)) : Scroll < e - s / 2 - 2 ? (jQuery(".border-line1").animate({height: Scroll}, 10, "linear"), r()) : Scroll < e - s / 2 && jQuery(".border-line1").animate({height: 2539}, 500, "linear") : 0 != jQuery(".oportunities").length ? ScrollBefore < Scroll ? Scroll < e - s / 2 ? (jQuery(".border-line1").animate({height: Scroll}, 10, "linear"), r()) : (jQuery(".border-line1").animate({height: e - 215}, 500, "linear"), clearTimeout($.data(this, "scrollTimer")), clearInterval(a)) : Scroll < e - s / 2 - 2 ? (jQuery(".border-line1").animate({height: Scroll}, 10, "linear"), r()) : Scroll < e - s / 2 && jQuery(".border-line1").animate({height: 6e3}, 500, "linear") : (jQuery(".border-line1").animate({height: Scroll}, 10, "linear"), r()), ScrollBefore = Scroll;
//     var l = $(this).scrollTop();
//     $(".projSlick .pad, blogSlick .pad, newsSlick .pad").length || $(".pad").each(function () {
//         l + n >= $(this).offset().top + 200 ? $(this).css({top: "0px"}) : l + n <= $(this).offset().top + 200 && $(this).css({top: "50px"})
//     });
//     var o = 0;
//
//     function r() {
//         clearTimeout($.data(this, "scrollTimer")), clearInterval(a), $.data(this, "scrollTimer", setTimeout(function () {
//             a = setInterval(function () {
//                 5 == o && (clearInterval(a), r()), t = 50 == t ? 0 : 50, jQuery(".border-line1").animate({height: Scroll - t}, 1e3, "linear"), o++
//             }, 1e3)
//         }, 500))
//     }
//
//     if (0 != jQuery(".LText").length && jQuery(".LText").css({top: 100 + .5 * Scroll + "px"}), 0 != jQuery(".blog-page .LText").length && jQuery(".blog-page .LText").css({top: 300 + .5 * Scroll + "px"}), 0 != jQuery(".RText").length && jQuery(".RText").css({top: 820 + .2 * Scroll + "px"}), 0 != jQuery(".RText2").length && jQuery(".RText2").css({top: 1720 + .2 * Scroll + "px"}), 0 != jQuery(".about").length && (0 != jQuery(".left-text").length && jQuery(".left-text").css({top: 1300 + .3 * Scroll + "px"}), 0 != jQuery(".right-text").length && jQuery(".right-text").css({top: 900 + .2 * Scroll + "px"}), 0 != jQuery(".right-text2").length && jQuery(".right-text2").css({top: 2160 + .3 * Scroll + "px"}), 0 != jQuery(".left-text2").length && jQuery(".left-text2").css({top: 2360 + .4 * Scroll + "px"})), 0 != jQuery(".prj-all").length && (0 != jQuery(".left-text").length && jQuery(".left-text").css({top: 300 + .4 * Scroll + "px"}), 0 != jQuery(".right-text").length && jQuery(".right-text").css({top: 50 + .2 * Scroll + "px"})), 0 != jQuery(".oportunities").length && (0 != jQuery(".left-text").length && jQuery(".left-text").css({top: 100 + .3 * Scroll + "px"}), 0 != jQuery(".right-text").length && jQuery(".right-text").css({top: 500 + .4 * Scroll + "px"}), 0 != jQuery(".right-text2").length && jQuery(".right-text2").css({top: 2460 + .3 * Scroll + "px"}), 0 != jQuery(".left-text2").length && jQuery(".left-text2").css({top: 460 + .6 * Scroll + "px"})), 0 != jQuery(".title-rotate1").length && (983 < Scroll ? jQuery(".title-rotate1").addClass("active") : Scroll < 983 && jQuery(".title-rotate1").removeClass("active")), 0 != jQuery(".title-rotate2").length && (1283 < Scroll ? jQuery(".title-rotate2").addClass("active") : Scroll < 1283 && jQuery(".title-rotate2").removeClass("active")), 0 != jQuery(".title-rotate3").length && (2e3 < Scroll ? jQuery(".title-rotate3").addClass("active") : Scroll < 2e3 && jQuery(".title-rotate3").removeClass("active")), 0 != jQuery(".title-rotate4").length && (2e3 < Scroll ? jQuery(".title-rotate4").addClass("active") : Scroll < 2e3 && jQuery(".title-rotate4").removeClass("active")), 0 != jQuery(".title-rotate5").length && (2e3 < Scroll ? jQuery(".title-rotate5").addClass("active") : Scroll < 2e3 && jQuery(".title-rotate5").removeClass("active")), 0 != jQuery(".title-rotate-blog1").length && (700 < Scroll ? jQuery(".title-rotate-blog1").addClass("active") : Scroll < 700 && jQuery(".title-rotate-blog1").removeClass("active")), 0 != jQuery(".title-rotate-blog2").length && (500 < Scroll ? jQuery(".title-rotate-blog2").addClass("active") : Scroll < 500 && jQuery(".title-rotate-blog2").removeClass("active")), 0 != jQuery(".title-rotate-blog3").length) {
//         var i = $(".post").outerHeight();
//         i + 300 < Scroll ? jQuery(".title-rotate-blog3").addClass("active") : Scroll < i + 300 && jQuery(".title-rotate-blog3").removeClass("active")
//     }
//     0 != jQuery(".oportunities").length && (0 != jQuery(".title-rotate1").length && (583 < Scroll ? jQuery(".title-rotate1").addClass("active") : Scroll < 583 && jQuery(".title-rotate1").removeClass("active")), 0 != jQuery(".title-rotate2").length && (1783 < Scroll ? jQuery(".title-rotate2").addClass("active") : Scroll < 1783 && jQuery(".title-rotate2").removeClass("active")), 0 != jQuery(".title-rotate3").length && (2800 < Scroll ? jQuery(".title-rotate3").addClass("active") : Scroll < 2800 && jQuery(".title-rotate3").removeClass("active")), 0 != jQuery(".title-rotate4").length && (3684 < Scroll ? jQuery(".title-rotate4").addClass("active") : Scroll < 3684 && jQuery(".title-rotate4").removeClass("active")), 0 != jQuery(".title-rotate5").length && (4893 < Scroll ? jQuery(".title-rotate5").addClass("active") : Scroll < 4893 && jQuery(".title-rotate5").removeClass("active")), 0 != jQuery(".title-rotate6").length && (5791 < Scroll ? jQuery(".title-rotate6").addClass("active") : Scroll < 5791 && jQuery(".title-rotate6").removeClass("active"))), 0 != jQuery("#filter").length && ($(window).scrollTop() >= jQuery(".filter-und").offset().top && $(window).scrollTop() >= jQuery(".filter-und").parent().offset().top ? (jQuery(".position-filter").css({
//         position: "fixed",
//         top: "0px",
//         "z-index": 102
//     }), jQuery(".filter-und").css({
//         position: "fixed",
//         top: "0px",
//         "z-index": "102"
//     })) : $(window).scrollTop() <= jQuery(".filter-und").parent().offset().top && (jQuery(".position-filter").css({
//         position: "relative",
//         "z-index": "102"
//     }), jQuery(".filter-und").css({position: "relative", "z-index": "102"})))
// });
...
angular
    ...
    .controller('MainController', ['$scope', function ($scope) {
        ...
        $scope.events = [
            {foo: 'bar', date: "2018-10-18"},
            {foo: 'bar', date: "2018-10-23"}
        ];
    }])
...
!function () {
    ...
    function t(e, t) {
        ...
        function D() {
            ...
            console.log(e.selectedMonth,e.selectedDay);
        }
